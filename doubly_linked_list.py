print("\nWelcome to Doubly Linked List Data Structure.!!!\n")
...
class Node:
    ...
    # Method to get previous data of a node
    def get_prev(self):
        return self.prev

    # Method to set previous data of a node
    def set_prev(self, prev):
        self.prev = prev


# Class DoublyLinkedList: Used for different operation insert, delete, display, search etc.
class DoublyLinkedList:
    ...
    def insert_at_pos(self, pos, data):
        if pos > self.length or pos < 0:
            ...
            next_to_current = current.get_next()
            next_to_current.set_prev(new_node)
            ...
            if pos > self.length or pos < 0:
                ...
                while current.get_next() != None or count < pos:
                    ...
                    if count == pos:
                        ...
                        next_to_current = current.get_next()
                        next_to_current.set_prev(previous)
                        self.length -= 1
    ...
    def delete_value(self, value):
        if self.length == 0:
            ...
            if current.data == value:
                ...
                if current.get_next() is None and current.data == value:
                    self.delete_from_end()
                else:
